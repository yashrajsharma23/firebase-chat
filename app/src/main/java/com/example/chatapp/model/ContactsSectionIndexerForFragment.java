...
public class ContactsSectionIndexerForFragment implements SectionIndexer {
	...
	public ContactsSectionIndexerForFragment(List<MultiContact> contacts) {
...
//		}
	...
	// return which section this item_codec_view belong to
	...
	public void initPositions(List<MultiContact> contacts)  {
		...
		for(MultiContact contact: contacts){
			...
			String indexableItem = contact.fullName;
			int sectionIndex = getSectionIndex(indexableItem); // find out which section this item_codec_view belong to
	...
	// if first item_codec_view in section, then return the section
	// otherwise return -1
	public boolean isFirstItemInSection(int position){ // check whether this item_codec_view is the first item_codec_view in section
